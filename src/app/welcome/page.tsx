...
import { ShieldCheck, ShoppingBag, ArrowRight, UserCheck, Sparkles, Footprints } from "lucide-react";
...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#E5E5E5] text-[#191c1e] font-sans flex flex-col items-center justify-center p-4 md:p-8">
      {/* Main Container */}
      <div className="w-full max-w-4xl bg-[#EFF4F8] rounded-[2.5rem] shadow-2xl overflow-hidden p-8 md:p-14 relative border border-white/60">
        {/* Top Header */}
        <div className="flex justify-between items-center mb-10">
          <div className="flex items-center gap-2.5">
            <div className="w-10 h-10 rounded-full bg-[#2a2a2a] text-[#D4FF00] flex items-center justify-center font-black shadow-sm">
          ...
          <span className="px-4 py-1.5 bg-[#D4FF00] text-[#1c1b1b] rounded-full text-xs font-extrabold uppercase tracking-wider">
            Prototype Demo
          </span>
        </div>
        ...
        {role === "choose" && (
          <div>
            <div className="text-center max-w-lg mx-auto mb-10">
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#191c1e] tracking-tight mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
              ...
              <div className="bg-[#2a2a2a] text-white rounded-3xl p-8 flex flex-col justify-between hover:scale-[1.02] transition-transform duration-300 shadow-xl border border-white/10 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#D4FF00]/10 rounded-full blur-2xl -mr-10 -mt-10" />
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-[#D4FF00] text-black flex items-center justify-center mb-6 shadow-md">
                    <ShieldCheck className="w-6 h-6" />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2">Merchant Command Center</h3>
                ...
                <Link
                  ...
                  className="w-full bg-[#D4FF00] text-[#1c1b1b] font-bold py-3.5 px-6 rounded-full text-sm hover:bg-[#c5e128] transition-colors flex items-center justify-center gap-2 shadow-lg"
                >
              ...
              <div className="bg-white text-[#191c1e] rounded-3xl p-8 flex flex-col justify-between hover:scale-[1.02] transition-transform duration-300 shadow-xl border border-[#e3beb6]/40 relative">
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-[#fee2dc] text-[#b32a03] flex items-center justify-center mb-6 shadow-sm">
                    <ShoppingBag className="w-6 h-6" />
                  </div>
                  <h3 className="text-2xl font-bold text-[#191c1e] mb-2">Customer Storefront</h3>
                  <p className="text-xs text-[#5a413a] leading-relaxed mb-6">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full bg-[#b32a03] text-white font-bold py-3.5 px-6 rounded-full text-sm hover:bg-[#8a1c00] transition-colors flex items-center justify-center gap-2 shadow-md"
                  >
                  ...
                  <button
                    ...
                    className="w-full bg-[#fee2dc] text-[#b32a03] font-bold py-3 px-6 rounded-full text-xs hover:bg-[#f8dcd6] transition-colors flex items-center justify-center gap-2"
                  >
        ...
        {/* New Customer Form */}
        {role === "customer_new" && (
          <div className="max-w-md mx-auto bg-white rounded-3xl p-8 shadow-xl border border-[#e3beb6]/40">
            <button
            ...
            <form onSubmit={handleCreateCustomer} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#b32a03] text-white font-bold py-3.5 px-6 rounded-full text-sm hover:bg-[#8a1c00] transition-colors flex items-center justify-center gap-2 shadow-lg disabled:opacity-50"
              >
