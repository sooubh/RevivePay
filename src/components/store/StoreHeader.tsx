...
export default function StoreHeader({ cartCount = 0 }: { cartCount?: number }) {
  ...
  return (
    <header className="fixed z-50 w-full top-0 bg-[#fff8f6]/90 backdrop-blur-xl border-b border-[#e3beb6]/30">
      <nav className="flex justify-between items-center w-full px-6 md:px-16 py-4 max-w-[1440px] mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center bg-white rounded-full px-4 py-2 border border-[#e3beb6] focus-within:border-[#b32a03] transition-colors">
            <Search className="w-4 h-4 text-[#8e7069] mr-2" />
            <input
              className="bg-transparent border-none outline-none focus:ring-0 text-sm text-[#271814] w-44 placeholder:text-[#8e7069]/60"
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-[#5a413a]">
        ...
        <div className="flex items-center gap-3 text-[#5a413a]">
          {customer ? (
            <Link
              href="/welcome"
              className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-[#fee2dc] text-[#b32a03] rounded-full text-xs font-bold hover:bg-[#f8dcd6] transition-colors"
            >
          ...
          <Link href="/merchant/overview" className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 bg-[#2a2a2a] text-[#D4FF00] rounded-full text-xs font-bold hover:bg-black transition-colors shadow-sm">
